...
global.dfail = (type, m, conn) => {
  const msg = {
    ...
    owner: '╭•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n│🔒     `𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀`      🔒\n╰•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n\n『✦』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙗𝙤𝙩𝙨 𝙤𝙛𝙞𝙘𝙞𝙖𝙡𝙚𝙨 𝙮 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧.',
    mods: '╭•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n│🔒     `𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀`      🔒\n╰•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n\n『✦』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙡𝙤𝙨 𝙢𝙤𝙙𝙚𝙧𝙖𝙙𝙤𝙧𝙚𝙨.',
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: wm, body: 'Bot de WhatsApp automático', thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaRibRvDuMRj6ozMSN1l'}}}}, aa);
