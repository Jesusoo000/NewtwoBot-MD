...
const handler = async (m, {conn, text, usedPrefix, command}) => {
 conn.sendMessage(m.chat, {text: `✅ 𝙉ewtwoBot-MD 𝙮𝙖 𝙚𝙨𝙩𝙖 𝙚𝙣 𝙨𝙪 𝙫𝙚𝙧𝙨𝙞𝙤𝙣 𝙢𝙖𝙨 𝙧𝙚𝙘𝙞𝙚𝙣𝙩𝙚, 𝙩𝙚 𝙣𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙧𝙚𝙢𝙤𝙨 𝙘𝙪𝙖𝙣𝙙𝙤 𝙚𝙡 𝙧𝙚𝙥𝙤𝙨𝙞𝙩𝙤𝙧𝙞𝙤 𝙩𝙚𝙣𝙜𝙖 𝙖𝙡𝙜𝙪𝙣𝙖 𝙖𝙘𝙩𝙪𝙖𝙡𝙞𝙯𝙖𝙘𝙞𝙤𝙣.`}, {quoted: m});  
try {
